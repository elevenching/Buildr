...
export const verificationSteps = Object.freeze([
  ...
  step({ id: 'cli-architecture', name: 'CLI modular architecture', executor: { type: 'node', file: 'test/verification/cli/architecture.mjs' }, profiles: ['fast', 'candidate'], inputs: ['bin/**', 'src/**', 'scripts/**', 'test/verification/**', 'package.json'] }),
  ...
  step({ id: 'integration-candidate-recovery', name: 'Candidate integration: builtin recovery and migration', executor: { type: 'npm', args: ['run', 'test:integration:candidate:recovery'] }, profiles: ['candidate'], groups: ['recovery'], inputs: [
    'test/integration-candidate-recovery/**', 'bin/buildr.mjs', 'buildr', 'src/**', 'src/infrastructure/runtime/**', 'skills/task-board/**', 'package/**',
  ...
  step({ id: 'managed-mutations', name: 'managed mutations', executor: { type: 'node', file: 'test/verification/integrity/managed-mutations.mjs' }, profiles: ['candidate'], groups: ['package'], inputs: ['src/**', 'src/infrastructure/runtime/**', 'package.json'] }),

  step({ id: 'capability-cli-integration', name: 'capability CLI integration', executor: { type: 'node', file: 'test/capability-cli.integration.mjs' }, profiles: ['candidate'], inputs: ['test/capability-cli.integration.mjs', 'src/**', 'package/targets/workspace/skills/**', 'package/targets/runtime/skills/**', 'skills/**', 'capabilities.yml'], budgetMs: 25000, schedulingCostMs: 19000, concurrencyClass: 'workspace-heavy' }),
  ...
  step({ id: 'cli-compatibility', name: 'CLI compatibility', executor: { type: 'node', file: 'test/verification/cli/compatibility.mjs' }, profiles: ['candidate'], groups: ['cli'], inputs: ['buildr', 'bin/buildr.mjs', 'src/**', 'test/verification/cli/compatibility.mjs', 'docs/cli-reference.md'], budgetMs: 15000, schedulingCostMs: 9000, concurrencyClass: 'workspace-heavy' }),
  step({ id: 'cli-package-parity', name: 'CLI package parity', executor: { type: 'node', file: 'test/verification/cli/package-parity.mjs', consumesArtifact: true }, profiles: ['candidate'], groups: ['cli'], inputs: ['buildr', 'bin/buildr.mjs', 'src/**', 'test/verification/cli/package-parity.mjs', 'package.json', 'package-lock.json'], dependsOn: ['candidate-tarball'], budgetMs: 10000, schedulingCostMs: 6000, concurrencyClass: 'workspace-heavy' }),
  ...
  step({ id: 'release-tarball-smoke', name: 'release tarball smoke', executor: { type: 'node', file: 'test/verification/release/release-smoke.mjs', consumesArtifact: true }, profiles: ['candidate'], groups: ['release'], inputs: ['buildr', 'bin/buildr.mjs', 'src/**', 'package.json', 'package-lock.json', 'test/verification/release/**'], dependsOn: ['candidate-tarball'], budgetMs: 10000, concurrencyClass: 'workspace-heavy' }),
  step({ id: 'managed-data-integrity', name: 'managed data integrity', executor: { type: 'node', file: 'test/verification/integrity/managed-data-integrity.mjs' }, profiles: ['candidate'], groups: ['package'], inputs: ['src/**', 'src/infrastructure/runtime/**', 'package/**', 'test/verification/integrity/**'], budgetMs: 15000, schedulingCostMs: 9000, concurrencyClass: 'workspace-heavy' }),
