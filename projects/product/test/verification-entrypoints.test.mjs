...
test('product verification exposes fast, affected, and candidate layers', () => {
  ...
  for (const forbidden of ['npm pack', 'npm install', 'verify-buildr-product-mvp', 'release-smoke.mjs']) {
