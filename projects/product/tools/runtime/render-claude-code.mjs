...
export function renderClaudeCode(argv, options = {}) {
  ...
  const command = options.command ?? 'node tools/runtime/render-claude-code.mjs';
...
export function installClaudeCodeBuildrSkill(argv, options = {}) {
  const repoRoot = options.repoRoot ?? process.cwd();
  const command = options.command ?? 'node tools/runtime/render-claude-code.mjs install';
