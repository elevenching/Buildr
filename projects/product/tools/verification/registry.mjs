...
export const verificationSteps = Object.freeze([
  step({ id: 'unit', name: 'fine-grained unit tests', executor: { type: 'npm', args: ['run', 'test:unit'] }, profiles: ['fast', 'candidate'], inputs: ['test/**', 'tools/**/*.mjs', 'tools/buildr', 'buildr', 'package.json', 'package-lock.json'], concurrencyClass: 'cpu-heavy' }),
  step({ id: 'cli-architecture', name: 'CLI modular architecture', executor: { type: 'node', file: 'tools/verification/cli/architecture.mjs' }, profiles: ['fast', 'candidate'], inputs: ['tools/**', 'package.json'], dependsOn: ['unit'] }),
  ...
  step({ id: 'capability-cli-integration', name: 'capability CLI integration', executor: { type: 'node', file: 'test/capability-cli.integration.mjs' }, profiles: ['candidate'], inputs: ['tools/cli/**', 'package/targets/workspace/skills/**', 'package/targets/runtime/skills/**', 'skills/**'], dependsOn: ['cli-architecture'], budgetMs: 30000, concurrencyClass: 'workspace-heavy' }),
