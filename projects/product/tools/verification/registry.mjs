...
export const verificationSteps = Object.freeze([
  ...
  step({ id: 'capability-cli-integration', name: 'capability CLI integration', executor: { type: 'node', file: 'test/capability-cli.integration.mjs' }, profiles: ['candidate'], inputs: ['test/capability-cli.integration.mjs', 'tools/cli/**', 'package/targets/workspace/skills/**', 'package/targets/runtime/skills/**', 'skills/**', 'capabilities.yml'], budgetMs: 30000, concurrencyClass: 'workspace-heavy' }),
  ...
  step({ id: 'runtime-adapter-parity', name: 'runtime adapter parity', executor: { type: 'node', file: 'tools/verification/runtime/adapter-parity.mjs' }, profiles: ['candidate'], groups: ['runtime'], inputs: ['tools/runtime/**', 'tools/cli/domains/runtime.mjs', 'tools/cli/application/doctor/runtime-diagnostics.mjs', 'package/targets/runtime/**', 'package/targets/workspace/rules/**', 'package/targets/workspace/skills/**'], budgetMs: 30000, concurrencyClass: 'workspace-heavy' }),
