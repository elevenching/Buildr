...
export const verificationSteps = Object.freeze([
  ...
  step({ id: 'runtime-adapter-parity', name: 'runtime adapter parity', executor: { type: 'node', file: 'tools/verification/runtime/adapter-parity.mjs' }, profiles: ['candidate'], groups: ['runtime'], inputs: ['tools/runtime/**', 'tools/cli/domains/runtime.mjs', 'tools/cli/application/doctor/runtime-diagnostics.mjs', 'package/targets/runtime/**', 'package/targets/workspace/rules/**', 'package/targets/workspace/skills/**'], budgetMs: 40000, schedulingCostMs: 30000, concurrencyClass: 'workspace-heavy' }),
