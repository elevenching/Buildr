...
export const verificationSteps = Object.freeze([
  ...
  step({ id: 'capability-cli-integration', name: 'capability CLI integration', executor: { type: 'node', file: 'test/capability-cli.integration.mjs' }, profiles: ['candidate'], inputs: ['test/capability-cli.integration.mjs', 'tools/cli/**', 'package/targets/workspace/skills/**', 'package/targets/runtime/skills/**', 'skills/**'], budgetMs: 30000, concurrencyClass: 'workspace-heavy' }),
